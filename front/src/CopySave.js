...
const CopySave = () => {
    ...
    const downLoadPdf = () =>{
        let content = constructTeXFile();
        setCommunicate({...communicate, fetchPdf: content})
    }
        ...
        <Box bg={"gray.50"}>
            ...
            <Center  >
                ...
                <HStack mt={"4px"} spacing={"1.5%"}>
                    ...
                    <Button m={"4px"} bg={"gray.200"} onClick={copyLaTeXCode}>
                        Copy <InlineMath>{' \\LaTeX'}</InlineMath> Code to a Clipboard
                    </Button>
                    <Button  bg={"gray.200"} onClick={() => {download(constructTeXFile(), "report.tex", "text/plain")}}>
                        <Text m={"4px"}>
                            Download as a <InlineMath>{'\\LaTeX'}</InlineMath> file
                        </Text>
                    </Button>
                    <Button  bg={"gray.200"} onClick={downLoadPdf}>
                        <Text m={"4px"} >
                            Download as a PDF
                        </Text>
                    </Button>
